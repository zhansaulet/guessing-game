...
describe('GuessingGame', () => {
    describe('#guess', () => {
        ...
        it('should guess number 409 with max value 4048', () => {
            ...
            game.lower();  // min 0 max 2024
            result = game.guess(); // 1012
            game.lower(); // min 0 max 1012
            result = game.guess(); // 506
            game.lower(); // min 0 max 506
            result = game.guess(); // 253
            game.greater(); // min 253 max 506
            result = game.guess(); // 379
            game.greater(); // min 379 max 506
            result = game.guess(); // 442
            game.lower(); // min 379 max 442
            result = game.guess(); // 410
            game.lower(); // min 379 max 410
            result = game.guess(); // 394
            game.greater(); // min 394 max 410
            result = game.guess(); // 402
            game.greater(); // min 402 max 410
            result = game.guess(); // 406
            game.greater(); // min 406 max 410
            result = game.guess(); // 408
            game.lower(); // min 408 max 410 
        ...
        it('should guess number 279 with max value 3445', () => {
            ...
            let result = game.guess(); //1722
            game.lower(); //min 0 max 1772
            result = game.guess(); // 861
            game.lower(); // min 0 max 861 
            result = game.guess(); // 430
            game.lower(); // min 0 max 430
            result = game.guess(); // 215
            game.greater(); // min 215 max 430
            result = game.guess(); // 322
            game.lower(); // min 215 max 322
            result = game.guess(); // 268
            game.greater(); // min 268 max 322
            result = game.guess(); // 295
            game.lower();  // min 268 max 295
            result = game.guess(); // 281
            game.lower(); // min 268 max 281
            result = game.guess(); // 274
            game.greater(); // min 274 max 281
            result = game.guess(); // 277
            game.lower(); //min 277 max 281
            result = game.guess(); //  279
        ...
        it('should guess number 286 with max value 1501', () => {
            ...
            let result = game.guess(); //750
            game.lower(); // min 0 max 750
            result = game.guess(); // 375 
            game.lower(); // min 0 max 375
            result = game.guess(); // 187
            game.greater(); // min 187 max 375
            result = game.guess(); // 281
            game.greater(); // min 281 max 375
            result = game.guess(); // 328
            game.lower(); // min 281 max 328
            result = game.guess(); // 304
            game.lower(); // min 281 max 304
            result = game.guess(); // 292
            game.lower(); // min 281 max 292
            result = game.guess(); // 286
            game.lower();
            result = game.guess();
            game.greater();
            result = game.guess();
